 ...
 * @LastEditors: hongbin
 * @LastEditTime: 2023-03-09 16:25:39
 * @Description:篮球游戏
 */
...
const init = (helper: ThreeHelper) => {
    ...
    Ammo().then(async (Ammo: any) => {
        ...
        helper.add(...wall);
        // wall.forEach((w) => ammoPhysics.addMesh(w));
        ...
        // ammoPhysics.addBox3Mesh(box, 300, { restitution: 0.5, needMove: true });
        ammoPhysics.addMeshByTriangle(box, 30, {
            restitution: 0.5,
            needMove: true,
        });
        // 控制器相机跟踪
